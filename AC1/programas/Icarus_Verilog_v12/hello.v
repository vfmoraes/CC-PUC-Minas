 ...
 */
  ...
  *
  *  After churning for a little while, 
  *  the program will create the output file "hello" which is compiled, 
  *  linked and ready to run. Run this program like so:
  *
  *      vvp hello.vvp
  *
  *  and the program will print the message to its output. Easy! 
  *  For more on how to make the iverilog command work, 
  *  see the iverilog manual page.
  */
